...
> 
> 예를 들어, 2009 년 12 월에는 임베디드 시스템 구축에 자주 사용되는 OSS이며, GPL2.0 라이선스인 「BusyBox」을 부적절하게 사용한 사용자를 저작권자가 고소한 소송이 있었습니다. 이 소송에서 소비자에게 제품을 판매하는 대표적인 회사를 포함한 총 14개 회사는 피고가 되었습니다. 해당 라이선스 규정은 소스 코드 공개가 의무화되어 있음에도 불구하고 소스 코드 공개가 이루어지지 않은 등의 문제가 있었습니다. 소송 건에 대해 많은 회사는 저작권자와 합의를 한 것 같지만, 판결이 내려져 소송 대상 일부 제품은 출하금지 명령을 받기도 하였습니다. 특히, 이 14개 회사 중에 ODM업체 개발제품에 자사 브랜드으로 판매되는 제품으로 인해 소송에 포함되어 문제를 지적 받은 사례도 있었습니다. 만일 ODM업체에 의해 개발된 제품일지라도 제품에 자사 브랜드 이름을 사용할 경우 판매한 브랜드 회사는 문제의 당사자가 된다는 점에 주목하여야 할 것입니다.
...
> 모든 경우에, OSS의 배포와 함께 배포하는 사람이 OSS 라이선스를 통해 저작권 소유자로부터 요구한 사항을 제대로 실행하지 않은 것으로 의심되어 결국 소송에 이르렀습니다. 소송을 당하는 상황은 어떻게해서도 피해야 합니다. 소송을 피하기 위해서는 다음 두 가지 항목에 힘써야 합니다.
...
> ## 소송에서 잃는 것은 무엇인가?
> 소송으로 받는 가장 큰 피해는 아마도 명예(reputation)가 손상되는 것입니다. 저작권법으로 보호되는 소프트웨어를 제대로 사용하지 않는다는 악명은 기존의 다른 회사에서 받고 있는 신뢰감조차도 훼손할 수 있습니다. 기업 활동에 따른 신뢰의 중요성을 인식하고 신뢰관계 구축에 대해 고심하는 기업일수록 '명예가 훼손되는 위험"(reputation risk)은 심각한 문제임에 틀림없습니다.
> 또한 소송에 대응하는 추가적인 노력과 비용이 소요됩니다. 소송으로 인해 더 건설적인 사업과 제품개발에 사용해야 할 인적자원을 소송 대응에 할애하는 비즈니스적인 기회손실이 발생하므로 기업 입장에서는 절실하게 피하고 싶은 상황일 것입니다. 게다가 OSS 라이선스 위반에 따른 소송에 대응할 수 있는 적절한 기량과 경험이 있는 전문 변호사 지원을 위한 비용도 늘어날 것입니다.
> 합의와 판결 상황에 따라 배상금 지불이 발생될 수도 있습니다. 극단적인 경우, 제품 출하금지가 되어 버리는 타격을 받을 가능성도 배제할 수 없습니다.
...
> ## OSS 커뮤니티와의 좋은 관계 구축
> 소송을 받게되는 사태를 피하려면, 배포하는 소프트웨어에 존재하는 OSS를 정확하게 파악하고 라이선스에 요구되는 사항을 우선 제대로 실행하는 것이 기본입니다. 이 외에도, OSS 개발자 커뮤니티에 기여하며 커뮤니티와 좋은 관계를 구축하는 것도 소송을 피하는 효과적인 방법입니다.
> OSS의 개발을 진행하는 커뮤니티가 왜 OSS 라이선스를 선택했는지, 그 배경에는 커뮤니티의 어떤 생각이 담겨 있는지를 이해함으로서 단지 라이선스 문서 표면적 의미에서 얻을 수 있는 내용보다 더 많은 지식과 견문을 얻을 수 있습니다. 개발자 커뮤니티와의 상호 신뢰관계는 다른 것으로도 대체하기 힘든 중요한 가치 중 하나가 될 것입니다.
> OSS 개발자 커뮤니티와의 신뢰관계를 구축할 수 있다면, 여러분은 자신이 가지고 있는 OSS에 대한 개선사항에 대해 커뮤니티에서 함께 검토를 할 수도 있습니다. 이외에도 커뮤니티와 교류를 가진 개발자는 관련 기술 분야에 대한 세계 최고 수준의 기량을 가진 사람과 커뮤니케이션 활동도 가능합니다. 같은 뜻을 가진 개발자들끼리의 스터디를 통한 기량 향상의 기회도 있습니다. 커뮤니티와의 연계는 기업도 인재육성의 관점에서도 놓칠 수 없는 것입니다.
> 오늘날의 소프트웨어 시스템은 대형화 고도화되어 복잡하게 얽혀 있습니다. 따라서 아무리 제대로 OSS에 대한 대응하더라도 실수를 할 가능성은 존재합니다. 실수를 한 상황에 대해 OSS 개발자 커뮤니티에 일정한 이해를 요구하는 상황이 생길 수도 있습니다. 당신이 커뮤니티 사람들로부터 신뢰를 얻고 있다면 만일 실수가 발생해도 그 사실을 커뮤니티에서 자비롭게 먼저 지적을 해줄지도 모릅니다.
